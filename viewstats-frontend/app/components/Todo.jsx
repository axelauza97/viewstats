export const Todo = ({ element, editHandler, deleteHandler }) => {
  return (
    <article className="m-2 grid w-56 grid-cols-2 grid-rows-2 items-center rounded border border-solid border-gray-700 bg-gray-50 px-2 py-2 shadow hover:scale-105 hover:cursor-pointer hover:border-gray-800">
